...
import com.raffle.controller.PromotionalPeriodController;
...
public class PromotionalPeriodControllerTests {
     ...
     */
    @Test
    public void raffleWinnersForPeriodThatExistsAndPurchasesForThisPeriodAreNotEmpty() throws EntityNotFoundException {
        ...
        participantJuan.setBuyer(juan.getBuyerId());
        ...
        participantPedro.setBuyer(pedro.getBuyerId());
        ...
        when(purchaseClient.getPurchasesBetweenPurchaseDateRageWithRaffleChances(promotionalPeriodTest.getPromotionStart().format(DateTimeFormatter.ISO_LOCAL_DATE), promotionalPeriodTest.getPromotionEnd().format(DateTimeFormatter.ISO_LOCAL_DATE))).thenReturn(participants);
